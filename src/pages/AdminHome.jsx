    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <div className="grid grid-cols-9 mt-15">
          <h1 className="font-sub text-xl col-span-2 col-start-2">
            Welcome, <span className="font-extrabold">Athena Patricio</span>!
          </h1>
          <Button className="col-span-1 col-end-9 content-center">
            Downloadables
            <span>
              <svg
        ...
        <h1 className="text-3xl font-main font-bold my-10 justify-self-center">
          ACCOUNT MANAGEMENT
        </h1>
